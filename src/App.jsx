...
import { Shield, Zap, Flame, Disc, Globe, Sun, RefreshCw, Skull, Trophy, Sparkles } from 'lucide-react';
import io from 'socket.io-client';

// REPLACE THIS URL WITH YOUR RENDER URL WHEN DEPLOYING
...
function WizBattles() {
  ...
  useEffect(() => {
    ...
    socket.on("round_complete", (data) => {
        ...
        setMessage("Resolving moves..."); // Clear "Waiting" message immediately
